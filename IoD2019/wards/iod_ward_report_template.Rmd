...
```{r lsoa_map,  echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.align="center", fig.cap="Contains Ordnance Survey data © Crown copyright and database right 2019"}
ggplot() +
  ...
  geom_text_repel(data = sf_lsoas_ward, aes(x = lon, y = lat, label = area_name), colour = "#2C3E50", size = 3, fontface = "bold") +
