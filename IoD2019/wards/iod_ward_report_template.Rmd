...
barcode_plot <- function (domain) {
  ...
  labs(x = NULL, y = NULL, title = NULL, subtitle = NULL,
       caption = "Source: 2019 Indices of Deprivation, MHCLG") +
  theme_lab() +
...
```{r barcode_imd, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_income, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_employment, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_education, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_health, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_crime, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_barriers, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_living, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_idaci, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
...
```{r barcode_idaopi, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.cap="Each line represents an LSOA."}
