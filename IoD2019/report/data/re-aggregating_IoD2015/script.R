...
# Read LSOA level IoD2015 data with population denominators
...
# Calculate average score for Income Deprivation Affecting Children sub-domain
...
# Calculate average score for Income Deprivation Affecting Older People sub-domain
