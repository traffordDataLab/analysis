...
Population changes comparing the Census 2021 with other estimates could be found in our separate report: [Comparing Population Estimates for Trafford](https://www.traffordDataLab.io/analysis/demographics/population/EstimatesAndProjections.html).
...
gg <- ggplot(pop_com_plot, aes(value, area_name)) +
  ...
  scale_x_continuous(labels=comma_format(digits=0), limits = c(-700,14000)) +
...
ggplot(pop_density, aes(value,area_name)) +
  ...
  scale_x_continuous(labels=comma_format(digits=0)) +
  scale_color_manual(values = c("#5d77a3", "#902082"), 
                     labels = c("2011", "2021")) +
