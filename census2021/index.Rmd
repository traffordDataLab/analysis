...
gg <- ggplot(w_dep_ch_To_Traf, aes(Percent, area_name)) +
  ...
  scale_x_continuous(limits = c(0,40)) +
    labs(x = "Percent", y = NULL, title = "Households with dependent children", subtitle = "Trafford MSOAs", caption = "Source: ONS  |  @traffordDataLab", colour = NULL) +
  theme_lab() +
  theme(plot.title = element_text(size=14),
        plot.subtitle = element_text(size=12),
        plot.caption = element_text(size=8, hjust = 1),
...
gg <- ggplot() +
  ...
  scale_x_continuous(limits = c(0,20)) +
    labs(x = "Percent", y = NULL, title = "One person household aged 66 years and over", subtitle = "Trafford MSOAs,2021", caption = "Source: ONS  |  @traffordDataLab", colour = NULL) +
  theme_lab() +
  theme(plot.title = element_text(size=14),
        plot.subtitle = element_text(size=12),
        plot.caption = element_text(size=8, hjust = 1),
...
gg <- ggplot(cobirth_p, aes(value,category)) +
  ...
  scale_color_manual(values = c("#5d77a3", "#902082"), 
                     labels = c("2011", "2021")) +
  labs(x = "residents", y = NULL, title = "Country of birth Change", subtitle = "Trafford residents born overseas by country", caption = "200 residents or more born in country\nSource: ONS  |  @traffordDataLab", colour = NULL) +
  theme_lab() +
  theme(plot.title = element_text(size=14),
        plot.subtitle = element_text(size=12),
        plot.caption = element_text(size=8, hjust = 1),
