...
gg <- ggplot() +
  geom_point_interactive(data = NCH_plot, aes(Value, area_name, tooltip = tooltip, color = Percent), size = 3) +
...
#2011 tenure link https://www.nomisweb.co.uk/api/v01/dataset/NM_619_1.data.csv?date=latest&geography=1946157089&rural_urban=0&cell=0,100,1...3,200,4,5,300,6...8&measures=20100,20301

#tenure_Traf_broad_2021 <- read_csv("https://www.nomisweb.co.uk/api/v01/dataset/NM_2072_1.data.csv?date=latest&geography=650117148&c2021_tenure_9=1001...1004,8&measures=20100,20301") %>%
...
### Mortgage payers and private renters
<br>
