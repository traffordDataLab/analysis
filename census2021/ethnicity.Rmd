...
ethnicity_age_sex_Trafford_p <- ethnicity_age_sex_Trafford %>% 
  ...
  left_join(ethnicity_age_sex_Trafford_2011 %>% select(area_name,category1,category2b,category3,value_2011 = value,Percent_2011 = Percent), by = c("area_name","category1","category2b","category3")) %>%
