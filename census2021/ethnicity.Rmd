...
The plot below shows a more detailed distribution of age and sex for each ethnic group. The age distribution vary greatly among ethnicity groups. 
<div class = "row">
<div class = "col-md-12">
...
gg <- ggplot(ethnicity_age_sex_Trafford_p ) + #%>% filter(category1 != "White")
  ...
  format(abs(x), ..., big.mark = ",", scientific = FALSE, trim = TRUE)
    ...
    labs(x = "% of residents of ethnic group", y = NULL, title = "Ethnicity by age and sex", subtitle = "Trafford 2021", caption = "", colour = NULL, fill = NULL) +
  theme_lab() +
    theme(plot.title = element_text(size=12),
        plot.subtitle = element_text(size=10, margin=margin(0,0,20,0)),
