...
This report is a brief exploratory Twitter analysis. [Part one](#part1) explores tweets mentioning @TraffordCouncil or the phrase "Trafford Council". [Part two](#part2) examines the last 1,000 tweets sent by @TraffordCouncil.

<br>

### Part one: tweets mentioning @TraffordCouncil or "Trafford Council" {#part1}
...
### Part two: tweets by @TraffordCouncil {#part2}
